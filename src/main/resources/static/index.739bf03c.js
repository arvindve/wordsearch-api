...
})({"b75oN":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
submitWordBtn.addEventListener("click", async ()=>{
    ...
    if (wordListSection.lastChild) wordListSection.removeChild(wordListSection.lastChild);
...
},{"./grid":"5bMWt"}],"5bMWt":[function(require,module,exports) {
...
class Grid {
    ...
    getCellsInRange(firstLetter, currentLetter) {
        ...
        else if (firstLetter.x === currentLetter.x) for(let i1 = firstLetter.y; i1 <= currentLetter.y; i1++)cellsInRange.push(this.gridArea.querySelector(`td[data-x="${currentLetter.x}"][data-y="${i1}"]`));
        else if (currentLetter.y - firstLetter.y === currentLetter.x - firstLetter.x) {
            let delta = currentLetter.y - firstLetter.y;
            for(let i = 0; i <= delta; i++)cellsInRange.push(this.gridArea.querySelector(`td[data-x="${i + firstLetter.x}"][data-y="${i + firstLetter.y}"]`));
        }
        return cellsInRange;
    }
    renderGrid(gridSize, wordGrid) {
        ...
        tbl.addEventListener("mousemove", (event)=>{
            if (this.wordSelectMode) {
                ...
                let x = +cell1.getAttribute("data-x");
                let y = +cell1.getAttribute("data-y");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"1XMv7"}],"1XMv7":[function(require,module,exports) {
...
},{}]},["b75oN","ebWYT"], "ebWYT", "parcelRequire94c2")
